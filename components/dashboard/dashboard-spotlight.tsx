...
export default function DashboardSpotlight({
  ...
  return (
    <div className="relative overflow-hidden rounded-[2.2rem] bg-stone-950 text-white shadow-2xl">
      <div className="relative z-10 grid grid-cols-1 gap-8 p-7 sm:p-10 lg:grid-cols-12 lg:items-center">
        {/* Left Column */}
        <div className="lg:col-span-7">
          <div>
            <span className="inline-flex items-center gap-1.5 rounded-full border border-amber-300/30 bg-amber-400/10 px-3.5 py-1 text-[11px] font-bold uppercase tracking-widest text-amber-300">
              <ShieldCheck className="h-3.5 w-3.5" />
              1-on-1 Native Mentorship
            </span>
          </div>

          <h2 className="mt-4 font-display text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-white leading-tight">
            Connect directly with verified native teachers.
          </h2>

          <p className="mt-3 text-sm leading-relaxed text-stone-300 max-w-xl font-medium">
          ...
          <div className="mt-7 flex flex-wrap items-center gap-4">
            <button
              ...
              className="group inline-flex items-center gap-3 rounded-full bg-white py-3 pl-6 pr-3 text-xs font-bold uppercase tracking-wider text-stone-950 shadow-lg transition hover:bg-stone-100 active:scale-95"
            >
              <span>Find a Native Tutor</span>
              <span className="flex h-7 w-7 items-center justify-center rounded-full bg-stone-950 text-white transition-transform group-hover:translate-x-0.5">
        ...
        <div className="lg:col-span-5">
          <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-white/10 p-5 backdrop-blur-md shadow-inner">
            <div className="flex items-center justify-between">
              <span className="rounded-full bg-emerald-500/20 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-emerald-300">
                Top Rated Educator
              </span>
            ...
            <div className="mt-4 flex items-center gap-4">
              <img
                ...
                className="h-14 w-14 rounded-2xl object-cover ring-2 ring-white/30 shadow-md"
              />
              <div className="min-w-0 flex-1">
                <h4 className="truncate font-display font-bold text-white text-base">
            ...
            <button
              type="button"
              onClick={onNavigateTeachers}
              className="mt-4 block w-full rounded-2xl bg-white/20 py-2.5 text-center text-xs font-bold uppercase tracking-wider text-white transition hover:bg-white/30"
            >
