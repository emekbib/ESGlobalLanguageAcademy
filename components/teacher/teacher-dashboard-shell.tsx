    ...
    <div className="min-h-screen bg-[#faf9f6]">
      ...
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-72 flex-col justify-between border-r border-stone-200/80 bg-white px-5 py-7 md:flex">
            ...
            <nav className="mt-3 space-y-1.5">
              ...
              {teacherProfile?.id && (
                <Link
                  ...
                  className="group flex w-full items-center gap-3.5 rounded-2xl px-4 py-3 text-sm font-semibold text-stone-600 hover:bg-stone-50 hover:text-stone-950 transition-all duration-200"
                >
                  <Eye className="h-4 w-4 shrink-0 text-stone-400 group-hover:text-stone-700" />
              ...
              <Link
                ...
                className="group flex w-full items-center gap-3.5 rounded-2xl px-4 py-3 text-sm font-semibold text-stone-600 hover:bg-stone-50 hover:text-stone-950 transition-all duration-200"
              >
                <Pencil className="h-4 w-4 shrink-0 text-stone-400 group-hover:text-stone-700" />
        ...
        <div className="space-y-4 border-t border-stone-100 pt-5">
          ...
          <div className="flex items-center justify-between rounded-2xl border border-stone-200/80 bg-stone-50/80 p-2.5 shadow-sm">
            <div className="flex items-center gap-3 min-w-0">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-stone-950 text-xs font-bold text-amber-300 shadow-sm">
                {profile.avatar_url ? (
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate text-xs font-bold text-stone-900">{profile.full_name}</p>
            ...
            <button
              ...
              className="rounded-xl p-2 text-stone-400 hover:bg-white hover:text-stone-950 hover:shadow-sm transition"
              title="Sign Out"
            >
          ...
          <div className="relative flex w-4/5 max-w-xs flex-1 flex-col bg-white p-6 shadow-2xl">
            <div className="flex items-center justify-between pb-6 border-b border-stone-100">
              <div className="flex items-center gap-2.5">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-stone-950 text-amber-300 shadow-sm">
              ...
              <button
                type="button"
                onClick={() => setMobileMenuOpen(false)}
                className="rounded-xl p-2 text-stone-400 hover:bg-stone-100 transition"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <nav className="mt-6 space-y-2">
              ...
              {teacherProfile?.id && (
                <Link
                  href={`/teachers/${teacherProfile.id}`}
                  className="flex w-full items-center gap-3.5 rounded-2xl px-4 py-3 text-sm font-semibold text-stone-600 hover:bg-stone-50"
                >
            ...
            <div className="mt-auto border-t border-stone-100 pt-6">
              <button
                type="button"
                onClick={() => setLogoutModalOpen(true)}
                className="flex w-full items-center gap-3 rounded-2xl border border-stone-200 bg-stone-50 p-3 text-xs font-bold text-stone-700 hover:bg-stone-100 transition"
              >
                <LogOut className="h-4 w-4" />
                Sign Out
              </button>
        ...
        <header className="sticky top-0 z-20 flex h-16 sm:h-18 w-full items-center justify-between border-b border-stone-200/80 bg-white/95 px-6 sm:px-10 backdrop-blur-md">
          ...
          <div className="flex items-center gap-3 md:hidden">
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-xl border border-stone-200 bg-white text-stone-700 shadow-sm"
            >
          ...
          <div className="flex items-center gap-3">
            {teacherProfile?.id && (
              <Link
                href={`/teachers/${teacherProfile.id}`}
                className="inline-flex items-center gap-2 rounded-full border border-stone-200 bg-white px-4 py-2 text-xs font-bold text-stone-800 shadow-sm transition hover:bg-stone-50"
              >
            ...
            <div className="flex h-9 w-9 items-center justify-center overflow-hidden rounded-full ring-2 ring-stone-200 shadow-sm">
              {profile.avatar_url ? (
                <img src={profile.avatar_url} alt={profile.full_name} className="h-full w-full object-cover" />
              ) : (
          ...
          {!teacherProfile ? (
            ...
            <>
              ...
              {activeTab === 'overview' && (
                <div className="space-y-6 animate-fade-in">
                  ...
                  <div className="border-b border-stone-200/80 pb-3">
                    ...
                    <h2 className="mt-0.5 font-display text-xl sm:text-2xl font-black tracking-tight text-stone-950">
                  ...
                  <div className="grid grid-cols-2 divide-y divide-stone-100 sm:grid-cols-4 sm:divide-y-0 sm:divide-x sm:divide-stone-100 rounded-2xl border border-stone-200/80 bg-white shadow-sm overflow-hidden">
                    <div className="flex flex-col justify-center px-5 py-4 text-left">
                      ...
                      <div className="mt-1 flex items-baseline gap-1.5">
                        ...
                        <span className="text-xs text-stone-500 font-medium">/ 50 min</span>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="flex flex-col justify-center px-5 py-4 text-left transition hover:bg-stone-50/80"
                    >
                      <span className="text-[10px] font-bold uppercase tracking-widest text-stone-400">
                        Upcoming Bookings
                      </span>
                    ...
                    <div className="flex flex-col justify-center px-5 py-4 text-left">
                      ...
                      <div className="mt-1 flex items-baseline gap-1.5">
                        ...
                        <span className="text-xs text-stone-500 font-medium">Verified</span>
                      </div>
                    </div>
                      ...
                      <div className="mt-1 flex items-center gap-1.5">
                        <span
                          className={`h-2 w-2 rounded-full ${
                            teacherProfile.is_published ? 'bg-emerald-500' : 'bg-stone-300'
                          }`}
                        />
                        <span className="font-display text-sm font-bold text-stone-950">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <h3 className="font-display text-lg font-black text-stone-950">
                        Weekly Availability Schedule
                      </h3>
              ...
              {activeTab === 'schedule' && (
                <div className="space-y-6 animate-fade-in">
                  <div className="border-b border-stone-200/80 pb-3">
                    <h2 className="font-display text-xl sm:text-2xl font-black tracking-tight text-stone-950">
                      Weekly Availability
                    </h2>
                    <p className="mt-0.5 text-xs text-stone-500 font-medium">
