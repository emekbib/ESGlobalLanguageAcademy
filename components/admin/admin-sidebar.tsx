  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-30 hidden w-72 flex-col justify-between border-r border-stone-200/80 dark:border-stone-800 bg-white dark:bg-stone-900 px-5 py-7 md:flex transition-colors duration-200">
      <div className="flex-1 overflow-y-auto pr-1">
        {/* Brand Logo: Minimalist Monogram + Editorial Wordmark */}
            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`group flex w-full items-center gap-3 rounded-2xl px-4 py-3 text-xs font-semibold transition-all duration-200 ${
                    isActive
