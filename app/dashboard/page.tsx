    ...
    <main className="min-h-screen bg-slate-50/70">
      <header className="border-b bg-background">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4"><span className="rounded-full border border-amber-300 bg-amber-50 px-3 py-1 text-[11px] font-bold uppercase tracking-wide text-amber-800">Deployment test</span><NotificationBell /><Link href="/teachers" className="hidden text-sm font-semibold text-primary hover:underline sm:block">Find a teacher</Link><ProfileMenu fullName={profile.full_name} avatarUrl={profile.avatar_url ?? null} /></div>
        </div>
      </header>
